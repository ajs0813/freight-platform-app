...
### 이용료와 거래 수수료는 다른 수익입니다

전국24시콜화물은 차주가 월 **정보이용료**를 내는 방식이 핵심 수익모델로 소개됩니다. 과거 보도의 월 2만 7,500원은 당시 금액이며 현행 요금으로 단정하지 않습니다. [상용차신문](https://www.cvinfo.com/news/articleView.html?idxno=23173) · [커넥터스](https://contents.premium.naver.com/connectx/us/contents/241106161253814js)

운송 건에서 주선사가 받는 수수료와 정보망 운영사가 받는 월 이용료는 구분해야 합니다. 우리 서비스의 과금 방식은 미정이며, 건당 수수료를 전제로 수익성을 계산하지 않습니다.
...
전국 단위 출시보다 먼저 **실제로 운송을 맡길 수 있는 고객과 운송 수행자에게 접근 가능한지** 확인합니다. 접근 가능한 의뢰처의 최근 운송 빈도·화물·구간을 파악하고, 같은 조건을 수락할 차주 또는 운송사를 확인합니다. 구체적인 의뢰처와 차주를 확보하지 못했다면 목표 고객과 운송 유형은 아직 선정된 것이 아닙니다.
...
| 검토 영역 | 아직 답해야 할 질문 |
|---|---|
| 고객 확보 | 첫 의뢰처에 접근할 경로가 있는가? 실제 반복 물량과 이를 수행할 차주를 확인했는가? 기존 서비스에서 바꿀 이유는 무엇인가? |
| 업무 범위·책임 | 어떤 화물·지역·운송 구간을 맡고, 미배차·지연·파손을 누가 처리하고 비용을 부담할까? |
| 수익성 | 월 이용료와 건당 수수료 중 누가 어떤 방식에 비용을 낼까? 예상 수입에서 고객 유치·배차 운영·고객지원·결제·보상 비용을 빼면 얼마가 남을까? |
